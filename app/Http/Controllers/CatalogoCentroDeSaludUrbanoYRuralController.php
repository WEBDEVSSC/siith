...
class CatalogoCentroDeSaludUrbanoYRuralController extends Controller
{
    //
    public function ocupacionCsuyrIndex()
    {
        ...
        return view('settings.csuyr-index', compact('ocupaciones'));
    }

    public function ocupacionCsuyrCreate()
    {
        // Cargamos la vista del formulario
        return view('settings.csuyr-create');
    }
    ...
    public function ocupacionCsuyrEdit($id)
    {
        ...
        return view('settings.csuyr-edit', compact('ocupacion'));
    }

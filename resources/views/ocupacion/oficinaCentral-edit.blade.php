...
@section('content_header')
    <h1><strong>Ocupación / Cartera de Servicios</strong> <small>Oficina Central</small></h1>
@stop
...
<div class="card">
    ...
    <form action="{{ route('updateOficinaCentral', $profesionalOcupaciones->id) }}" method="POST">
        @csrf 
        @method('PUT')

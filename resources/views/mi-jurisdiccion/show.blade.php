...
<div class="card">
        <div class="card-header">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <a href="{{ route('miJurisdiccionBajaDefinitiva') }}" 
                    ...
                    @forelse($profesionales as $profesional)
                        <tr>
                            ...
                            <!-- SI EL ROL ES DIFERENTE A DIRECTIVO SE MUESTRAN LOS BOTONES DE EDICION DE LOS MODULOS  -->
                                ...
                                @if (
                                    !filled($profesional->padre_madre_familia) || 
                                    !filled($profesional->estado_conyugal)
                                )

                                    <a href="{{ route('profesionalEdit', $profesional->id) }}"

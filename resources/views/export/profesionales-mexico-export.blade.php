        ...
        <tbody>
            @foreach($profesionales as $profesional)
                <tr>
                    ...
                    <td>
                         @if ($profesional->pais_nacimiento == NULL || $profesional->pais_nacimiento == '')
                              SE IGNORA
                         @else
                              {{ eliminar_acentos($profesional->pais_nacimiento ?? '')  }}
                         @endif
                    </td>
                    ...
                    <td>{{ $profesional->ocupacionEnsenanza->s_area_trabajo_uno ?? '' }}</td>

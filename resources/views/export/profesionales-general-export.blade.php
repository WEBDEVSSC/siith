    ...
    <table>
        <thead>
            <tr>
                ...
                <th colspan="11" style="text-align: center; font-size: 20px; font-weight: bold;">JORNADA LABORAL</th>
            ...
            <tr>
                ...
                {{-- CATALOGO/CARTERA SERVICIOS (PRINCIPAL) --}}
                <th><strong>OCUPACION CATALOGO</strong></th>

                <th><strong>UNIDAD</strong></th>
                <th><strong>AREA</strong></th>
                <th><strong>SUBAREA SERVICIO</strong></th>
                <th><strong>SUBAREA</strong></th>
                <th><strong>JEFATURA_PROGRAMA</strong></th>
                ...
                {{-- CATALOGO/CARTERA SERVICIOS (SECUNDARIO) --}}
                <th><strong>UNIDAD</strong></th>
                <th><strong>AREA</strong></th>
                <th><strong>SUBAREA SERVICIO</strong></th>
                <th><strong>SUBAREA</strong></th>
                ...
                <th><strong>RFC - HOMOCLAVE</strong></th>
                ...
                <th><strong>ADSCRIPCION FISICA</strong></th>
                <th><strong>NOMINA DE PAGO</strong></th>
                <th><strong>CODIGO DE PUESTO</strong></th>
                <th><strong>DESCRIPCION CODIGO</strong></th>
                ...
                <th><strong>LICENCIA MATERNIDAD</strong></th>
                ...
                <th><strong>ENTRADA PROMEDIO</strong></th>
                <th><strong>SALIDA PROMEDIO</strong></th>
                ...
                {{-- PERSONAL ESTUDIANDO ACTUALMENTE --}}
        ...
        <tbody>
            @foreach($profesionales as $profesional)
                <tr>
                    ...
                    {{-- CREDENCIALIZACION--}}
                    <td>@if(!empty($profesional->credencializacion->fotografia))
                        SI
                    @else
                        NO
                    @endif</td>

                    {{-- CATALOGO/CARTERA SERVICIOS (PRINCIPAL Y SECUNDARIO) --}}
                    ...
                    <td>{{ optional($profesional->fecha_nacimiento)->format('d-m-Y') }}</td>
                    ...
                    <td>J.{{ $profesional->puesto?->clues_nomina_jurisdiccion ?? '' }} - {{$profesional->puesto?->clues_nomina_nombre}}</td>
                    <td>J.{{ $profesional->puesto?->clues_adscripcion_jurisdiccion ?? '' }} - {{$profesional->puesto?->clues_adscripcion_nombre}}</td>

...
@section('content_header')
    <h1><strong>Ocupaciones (México)</strong></h1>
@stop
            ...
            <tbody>
                @foreach ($ocupaciones as $ocupacion)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('nominaPagoEdit', $ocupacion->id) }}" class="btn btn-warning btn-sm">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            
                            <form action="{{ route('nominaPagoDelete', $ocupacion->id) }}" method="POST" style="display:inline;" class="form-eliminar">
                                @csrf
                                @method('DELETE')

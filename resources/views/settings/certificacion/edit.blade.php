...
@section('content_header')
    <h1><strong>Certificaciones</strong> <small>Editar</small></h1>
@stop
...
<div class="card">
        <div class="card-header">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('updateCertificacion', $certificacion->id) }}" method="POST">
                ...
                <div class="row mt-3">      
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="certificacion" class="form-control" value="{{ old('certificacion', $certificacion->certificacion) }}">
                        @error('certificacion')

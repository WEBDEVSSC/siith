...
<!-- -->
    ...
    <div class="card">
        ...
        <form action="{{ route('ocupacionOfJurisdiccionalUpdate', $ocupacion->id) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="servicio" id="servicio" class="form-control" value="{{ old('servicio', $ocupacion->servicio) }}">
                    @error('servicio')
                        <br><div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.00001" name="orden" id="orden" class="form-control" value="{{ old('orden', $ocupacion->orden) }}">
                    @error('orden')
                        <br><div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>

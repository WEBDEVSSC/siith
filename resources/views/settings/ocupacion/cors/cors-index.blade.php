...
<div class="card">
        ...
        <div class="card-header text-right d-flex justify-content-end align-items-center">
            <a href="{{ route('ocupacionCorsCreate') }}" class="btn btn-success btn-sm">
                <i class="fas fa-plus mr-1" style="margin-right: 5px;"></i> NUEVO REGISTRO
            </a>
            <a href="{{ route('ocupacionCorsPDF') }}" target="_blank" class="btn btn-danger btn-sm" style="margin-left: 10px;">
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <div class="d-flex justify-content-center align-items-center" style="gap: 5px;">
                                <!-- Botón Editar -->
                                <a href="{{ route('ocupacionCorsEdit', $ocupacion->id) }}" class="btn btn-warning btn-sm" title="Editar registro">
                                    <i class="fas fa-edit text-white"></i>
                                </a>

                                <!-- Botón Eliminar -->
                                <form action="{{ route('ocupacionCorsDestroy', $ocupacion->id) }}" method="POST" class="form-eliminar d-inline">
                                    @csrf
                                    @method('DELETE')

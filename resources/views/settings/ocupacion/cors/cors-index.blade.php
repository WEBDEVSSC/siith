...
@section('content_header')
    <h1><strong>Profesionales | Ocupaciones</strong> <small>C.O.R.S.</small></h1>
@stop
...
<div class="card">
        <div class="card-header">
            <a href="{{ route('ocupacionCorsCreate') }}" class="btn btn-success btn-sm">NUEVO REGISTRO</a>
        </div>
        <div class="card-body">
                ...
                @foreach ($ocupaciones as $ocupacion)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('ocupacionCorsDestroy', $ocupacion->id) }}" method="POST" class="form-eliminar">
                                @csrf
                                @method('DELETE')

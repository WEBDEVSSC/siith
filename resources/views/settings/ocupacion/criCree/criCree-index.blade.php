...
<div class="card">
        <div class="card-header">
            <a href="{{ route('ocupacionCriCreeCreate') }}" class="btn btn-success btn-sm">NUEVO REGISTRO</a>
        </div>
        <div class="card-body">
                ...
                @foreach ($ocupaciones as $ocupacion)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('ocupacionCriCreeEdit', $ocupacion->id) }}" class="btn btn-warning btn-sm btn-block">EDITAR</a>

                            <br>

                            <form action="{{ route('ocupacionCriCreeDestroy', $ocupacion->id) }}" method="POST" class="form-eliminar">
                                @csrf
                                @method('DELETE')

...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Ocupaciones - Almacen</title>
    <style>
        @page {
...
<body>
    ...
    <div class="header">
        ...
        <div class="subtitle">Almacén</div>
    </div>
        ...
        <tbody>
            @forelse ($ocupaciones as $ocupacion)
                <tr>
                    ...
                    <td class="text-left">{{ $ocupacion->jefatura ?? '-' }}</td>
                    <td class="text-left">{{ $ocupacion->departamento ?? '-' }}</td>
            ...
            @empty
                <tr>
                    <td colspan="9" class="text-center" style="padding: 15px; color: #888888;">

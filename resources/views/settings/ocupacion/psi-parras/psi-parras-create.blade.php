...
@section('content_header')
    <h1><strong>Profesionales | Ocupaciones</strong> <small>PSI Parras</small></h1>
@stop
...
<!-- -->
    ...
    <div class="card">
        ...
        <form action="{{ route('ocupacionPsiParrasStore') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="subarea_servicio" id="subarea_servicio" class="form-control" value="{{ old('subarea_servicio') }}">

...
<div class="card">
        <div class="card-header">
            <a href="{{ route('ocupacionCecosamaCreate') }}" class="btn btn-success btn-sm">NUEVO REGISTRO</a>
        </div>
        <div class="card-body">
                ...
                @foreach ($ocupaciones as $ocupacion)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('ocupacionCecosamaDestroy', $ocupacion->id) }}" method="POST" class="form-eliminar">
                                @csrf
                                @method('DELETE')

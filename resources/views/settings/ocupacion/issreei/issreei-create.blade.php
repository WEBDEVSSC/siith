...
@section('content_header')
    <h1><strong>Profesionales | Ocupaciones</strong> <small>I.S.S.R.E.E.I.</small></h1>
@stop
...
<!-- -->
    ...
    <div class="card">
        ...
        <form action="{{ route('ocupacionIssreeiStore') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <p>Jefatura</p>
                    <input type="text" name="jefatura" id="jefatura" class="form-control" value="{{ old('jefatura') }}">
                    @error('jefatura')
                        <br><div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>

...
@section('content_header')
    <h1><strong>Ocupaciones / Cartera de Servicios</strong> <small>Hospital del Niño</small></h1>
@stop
...
<!-- -->
    ...
    <div class="card">
        ...
        <form action="{{ route('ocupacionHospitalNinoUpdate', $ocupacion->id) }}" method="POST">

...
@section('content_header')
    <h1><strong>Ocupaciones / Cartera de Servicios</strong> <small>Hospital</small></h1>
@stop
...
<!-- -->
    ...
    <div class="card">
        ...
        <form action="{{ route('ocupacionHospitalUpdate', $ocupacion->id) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <p>Puesto</p>
                    <input type="text" name="puesto" id="puesto" class="form-control" value="{{ old('puesto', $ocupacion->puesto) }}">
                    @error('puesto')
                        <br><div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>

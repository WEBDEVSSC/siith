...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Ocupaciones - Hospital</title>
    <style>
        @page {
...
<body>
    ...
    <div class="header">
        ...
        <div class="subtitle">Hospitales</div>
    </div>
        ...
        <tbody>
            @forelse ($ocupaciones as $ocupacion)
                <tr>
                    ...
                    <td class="text-left">{{ $ocupacion->puesto ?? '-' }}</td>
                    <td class="text-left">{{ $ocupacion->s_area_trabajo ?? '-' }}</td>
                    <td class="text-left">{{ $ocupacion->s_ocupacion ?? '-' }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="8" class="text-center" style="padding: 15px; color: #888888;">

    ...
    <table>
        ...
        <tr>
            <td colspan="9" style="font-size: 10pt; text-align: center; color: #555555;">
                Oficina Central - Subdirección de Recursos Humanos
            </td>
        </tr>
        <tr>
        ...
        <thead>
            <tr>
                ...
                <th style="background-color: #2b3e50; color: #ffffff; font-weight: bold; text-align: center; border: 1px solid #1a252f;">Programa</th>
        ...
        <tbody>
            @forelse ($ocupaciones as $index => $ocupacion)
                ...
                <tr>
                    ...
                    <td style="background-color: {{ $bgColor }}; border: 1px solid #dcdcdc;">{{ $ocupacion->programa ?? '-' }}</td>

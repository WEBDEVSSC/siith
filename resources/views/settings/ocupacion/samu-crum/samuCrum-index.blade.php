...
<div class="card">
        <div class="card-header">
            <a href="{{ route('ocupacionSamuCrumCreate') }}" class="btn btn-success btn-sm">NUEVO REGISTRO</a>
        </div>
        <div class="card-body">
                ...
                @foreach ($ocupaciones as $ocupacion)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('ocupacionSamuCrumEdit', $ocupacion->id) }}" class="btn btn-warning btn-sm btn-block">EDITAR</a>

                            <br>

                            <form action="{{ route('ocupacionSamuCrumDestroy', $ocupacion->id) }}" method="POST" class="form-eliminar">
                                @csrf
                                @method('DELETE')

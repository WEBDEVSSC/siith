...
@section('content_header')
    <h1><strong>Profesionales | Ocupaciones</strong> <small>C.E.S.A.M.E.</small></h1>
@stop
...
<div class="card">
        <div class="card-header">
            <a href="{{ route('ocupacionCesameCreate') }}" class="btn btn-success btn-sm">NUEVO REGISTRO</a>
        </div>
        <div class="card-body">
                ...
                @foreach ($ocupaciones as $ocupacion)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('ocupacionCesameEdit', $ocupacion->id) }}" class="btn btn-warning btn-sm btn-block">EDITAR</a>

                            <br>

                            <form action="{{ route('ocupacionCesameDestroy', $ocupacion->id) }}" method="POST" class="form-eliminar">
                                @csrf
                                @method('DELETE')

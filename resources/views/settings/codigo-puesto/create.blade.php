...
<div class="card">
        ...
        <form action="{{ route('storeCodigos') }}" method="POST">
        ...
        <div class="row">
           ...
           <div class="col-md-3">
                ...
                <select name="rama" id="rama" class="form-control">
                    ...
                    <option value="ADMINISTRATIVA" {{ old('rama') == 'ADMINISTRATIVA' ? 'selected' : '' }}>ADMINISTRATIVA</option>
                    <option value="AFIN" {{ old('rama') == 'AFIN' ? 'selected' : '' }}>AFIN</option>
                    <option value="ENFERMERIA" {{ old('rama') == 'ENFERMERIA' ? 'selected' : '' }}>ENFERMERIA</option>
                    <option value="FORMACION" {{ old('rama') == 'FORMACION' ? 'selected' : '' }}>FORMACION</option>
                    <option value="MEDICA" {{ old('rama') == 'MEDICA' ? 'selected' : '' }}>MEDICA</option>
                    <option value="PARAMEDICA" {{ old('rama') == 'PARAMEDICA' ? 'selected' : '' }}>PARAMEDICA</option>
                </select>

    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            <div class="col-md-2">
                ...
                <div class="info-box-content">
                    <a href="{{ route('indexInstitucionEducativa') }}"><span class="info-box-text"><span class="info-box-text"><span class="info-box-text">Inst. Educativa</span></a>
                </div>
                <!-- /.info-box-content -->
                </div>
            </div>
            ...
            <div class="col-md-2">
                ...
                <div class="info-box-content">
                    <a href="{{ route('indexTitulo') }}"><span class="info-box-text"><span class="info-box-text"><span class="info-box-text">Titulos</span></a>
                </div>
                <!-- /.info-box-content -->
                </div>
            </div>
            ...
            <div class="col-md-2">
                ...
                <div class="info-box-content">
                    <a href="{{ route('registrosInactivos') }}"><span class="info-box-text"><span class="info-box-text"><span class="info-box-text">Eliminados</span></a>
                </div>
                <!-- /.info-box-content -->
                </div>
            </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="info-box-content">
                    <a href="{{ route('indexBitacoraOcupacion') }}"><span class="info-box-text"><span class="info-box-text"><span class="info-box-text">Bitacora Ocupación</span></a>
                </div>
                <!-- /.info-box-content -->
                </div>
            </div>

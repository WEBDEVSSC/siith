...
<div class="card">
        <div class="card-header">
            <a href="{{ route('vigenciasCreate') }}" class="btn btn-success btn-sm">NUEVO REGISTRO</a>
        </div>
        <div class="card-body">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @foreach ($vigencias as $vigencia)
                    <tr>
                        <td>{{ $vigencia->id }}</td>                     
                        <td>{{ $vigencia->label_vigencia }}</td>                 
                        <td>{{ $vigencia->motivo }}</td>                    
                        <td>
                    
                            <a href="{{ route('vigenciasEdit', $vigencia->id) }}" class="btn btn-warning btn-sm btn-block">EDITAR</a>

                            <br>

                            <form action="{{ route('vigenciasDestroy', $vigencia->id) }}" method="POST" class="form-eliminar">
                                @csrf
                                @method('DELETE')

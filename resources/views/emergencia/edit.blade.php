...
@section('content')
    ...
    <div class="alert alert-info" role="alert">
        ...
        <ul>
            <li><strong>Nombre</strong> : {{ $profesional->nombre }} {{ $profesional->apellido_paterno }}
                {{ $profesional->apellido_materno }}</li>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('emergenciaPDF', $profesional->id) }}" class="btn btn-warning btn-sm" target="_blank"><i
            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="telefono_celular" class="form-control" maxlength="10"
                            value="{{ old('telefono_celular', $emergencia->telefono) }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="email" name="correo_electronico" class="form-control"
                            value="{{ old('correo_electronico', $emergencia->correo_electronico) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="alergia_descripcion" id="alergia_descripcion" class="form-control"
                            value="{{ old('alergia_descripcion', $emergencia->alergia_descripcion) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="enfermedad" id="enfermedad" class="form-control"
                            value="{{ old('enfermedad', $emergencia->enfermedad) }}">
                        @error('enfermedad')
                            <br>
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="medicamentos" id="medicamentos" class="form-control"
                            value="{{ old('medicamentos', $emergencia->medicamentos) }}">
                        @error('medicamentos')
                            <br>
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="medico_nombre" id="medico_nombre" class="form-control"
                            value="{{ old('medico_nombre', $emergencia->medico_nombre) }}">
                        @error('medico_nombre')
                            <br>
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="medico_telefono" id="medico_telefono" class="form-control"
                            value="{{ old('medico_telefono', $emergencia->medico_telefono) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <p><strong>Nombre</strong></p>
                        <input type="text" name="emergencia_nombre_uno" id="emergencia_nombre_uno"
                            class="form-control"
                            value="{{ old('emergencia_nombre_uno', $emergencia->emergencia_nombre_uno) }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="emergencia_telefono_uno_uno" id="emergencia_telefono_uno_uno"
                            class="form-control"
                            value="{{ old('emergencia_telefono_uno_uno', $emergencia->emergencia_telefono_uno_uno) }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="emergencia_telefono_dos_uno" id="emergencia_telefono_dos_uno"
                            class="form-control"
                            value="{{ old('emergencia_telefono_dos_uno', $emergencia->emergencia_telefono_dos_uno) }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="emergencia_email_uno" id="emergencia_email_uno" class="form-control"
                            value="{{ old('emergencia_email_uno', $emergencia->emergencia_email_uno) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="emergencia_calle_uno" id="emergencia_calle_uno" class="form-control"
                            value="{{ old('emergencia_calle_uno', $emergencia->emergencia_calle_uno) }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="emergencia_numero_uno" id="emergencia_numero_uno"
                            class="form-control"
                            value="{{ old('emergencia_numero_uno', $emergencia->emergencia_numero_uno) }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="emergencia_colonia_uno" id="emergencia_colonia_uno"
                            class="form-control"
                            value="{{ old('emergencia_colonia_uno', $emergencia->emergencia_colonia_uno) }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="emergencia_codigo_postal_uno" id="emergencia_codigo_postal_uno"
                            class="form-control"
                            value="{{ old('emergencia_codigo_postal_uno', $emergencia->emergencia_codigo_postal_uno) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control entidad-select" name="emergencia_estado_uno_id"
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="municipio_uno" class="form-control" name="emergencia_municipio_uno_id">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <p><strong>Nombre</strong></p>
                        <input type="text" name="emergencia_nombre_dos" id="emergencia_nombre_dos"
                            class="form-control"
                            value="{{ old('emergencia_nombre_dos', $emergencia->emergencia_nombre_dos) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Teléfono Principal</strong></p>
                        <input type="text" name="emergencia_telefono_uno_dos" id="emergencia_telefono_uno_dos"
                            class="form-control"
                            value="{{ old('emergencia_telefono_uno_dos', $emergencia->emergencia_telefono_uno_dos) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Teléfono Secundario</strong></p>
                        <input type="text" name="emergencia_telefono_dos_dos" id="emergencia_telefono_dos_dos"
                            class="form-control"
                            value="{{ old('emergencia_telefono_dos_dos', $emergencia->emergencia_telefono_dos_dos) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>E-mail</strong></p>
                        <input type="text" name="emergencia_email_dos" id="emergencia_email_dos" class="form-control"
                            value="{{ old('emergencia_email_dos', $emergencia->emergencia_email_dos) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <p><strong>Calle</strong></p>
                        <input type="text" name="emergencia_calle_dos" id="emergencia_calle_dos" class="form-control"
                            value="{{ old('emergencia_calle_dos', $emergencia->emergencia_calle_dos) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Número</strong></p>
                        <input type="text" name="emergencia_numero_dos" id="emergencia_numero_dos"
                            class="form-control"
                            value="{{ old('emergencia_numero_dos', $emergencia->emergencia_numero_dos) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Colonia</strong></p>
                        <input type="text" name="emergencia_colonia_dos" id="emergencia_colonia_dos"
                            class="form-control"
                            value="{{ old('emergencia_colonia_dos', $emergencia->emergencia_colonia_dos) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Código Postal</strong></p>
                        <input type="text" name="emergencia_codigo_postal_dos" id="emergencia_codigo_postal_dos"
                            class="form-control"
                            value="{{ old('emergencia_codigo_postal_dos', $emergencia->emergencia_codigo_postal_dos) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        <p><strong>Entidad</strong></p>
                        <select class="form-control entidad-select" name="emergencia_estado_dos_id"
                    ...
                    <div class="col-md-3">
                        <p><strong>Municipio</strong></p>
                        <select id="municipio_dos" class="form-control" name="emergencia_municipio_dos_id">
                            <option value="">Seleccione un municipio</option>
                        </select>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <p><strong>Nombre</strong></p>
                        <input type="text" name="emergencia_nombre_tres" id="emergencia_nombre" class="form-control"
                            value="{{ old('emergencia_nombre_tres', $emergencia->emergencia_nombre_tres) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Teléfono Principal</strong></p>
                        <input type="text" name="emergencia_telefono_uno_tres" id="emergencia_telefono_uno_tres"
                            class="form-control"
                            value="{{ old('emergencia_telefono_uno_tres', $emergencia->emergencia_telefono_uno_tres) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Teléfono Secundario</strong></p>
                        <input type="text" name="emergencia_telefono_dos_tres" id="emergencia_telefono_dos_tres"
                            class="form-control"
                            value="{{ old('emergencia_telefono_dos_tres', $emergencia->emergencia_telefono_dos_tres) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>E-mail</strong></p>
                        <input type="text" name="emergencia_email_tres" id="emergencia_email_tres"
                            class="form-control"
                            value="{{ old('emergencia_email_tres', $emergencia->emergencia_email_tres) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4">
                        <p><strong>Calle</strong></p>
                        <input type="text" name="emergencia_calle_tres" id="emergencia_calle_tres"
                            class="form-control"
                            value="{{ old('emergencia_calle_tres', $emergencia->emergencia_calle_tres) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Número</strong></p>
                        <input type="text" name="emergencia_numero_tres" id="emergencia_numero_tres"
                            class="form-control"
                            value="{{ old('emergencia_numero_tres', $emergencia->emergencia_numero_tres) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Colonia</strong></p>
                        <input type="text" name="emergencia_colonia_tres" id="emergencia_colonia_tres"
                            class="form-control"
                            value="{{ old('emergencia_colonia_tres', $emergencia->emergencia_colonia_tres) }}">
                    ...
                    <div class="col-md-2">
                        <p><strong>Código Postal</strong></p>
                        <input type="text" name="emergencia_codigo_postal_tres" id="emergencia_codigo_postal_tres"
                            class="form-control"
                            value="{{ old('emergencia_codigo_postal_tres', $emergencia->emergencia_codigo_postal_tres) }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3">
                        <p><strong>Entidad</strong></p>
                        <select class="form-control entidad-select" name="emergencia_estado_tres_id"
                    ...
                    <div class="col-md-3">
                        <p><strong>Municipio</strong></p>
                        <select id="municipio_tres" class="form-control" name="emergencia_municipio_tres_id">
                            <option value="">Seleccione un municipio</option>
                        </select>
